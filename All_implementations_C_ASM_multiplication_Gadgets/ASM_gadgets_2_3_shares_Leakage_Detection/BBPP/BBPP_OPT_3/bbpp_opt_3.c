//Algorithm 4, Paper: Randomness Complexity of Private Circuits for Multiplication

#include <stdio.h>
#include <stdlib.h>
#include "bbpp_opt_3.h"
...
int  share_n = 3;
/*The number of randomness for gadget: BBPP:
 * if share_n <= 3: rnd_n = share_n - 1
 * if share_n > 3: rnd_n = share_n */
...
//        scale_gpio_wr( SCALE_GPIO_PIN_TRG, true  );
        ...
        Bbpp_opt_3(shares_a, shares_b, rnd, shares_ab);
//                Bbpp_opt_3(shares_a, shares_b, rnd, output);
