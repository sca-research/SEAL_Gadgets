...
// and its corresponding power is measured via PicoScope
int share_n = 3;
/*The number of randomness for gadget: dom_indep_3: share_n *(share_n - 1)/2 */
...
//        scale_gpio_wr( SCALE_GPIO_PIN_TRG, true  );
        ...
        Dom_indep_3(shares_a, shares_b, rnd, shares_ab);
//                Dom_indep_3(shares_a, shares_b, rnd, output);
