...
int share_n = 3;
/*The number of randomness for gadget: hpc1_opt_3: Mask_order*(Mask_order+1)/2+Mask_order */
// int rnd_gadget = share_n - 1;
int rnd_n = 5;
...
//                HPC1_opt_3(shares_a, shares_b, rnd, output);
