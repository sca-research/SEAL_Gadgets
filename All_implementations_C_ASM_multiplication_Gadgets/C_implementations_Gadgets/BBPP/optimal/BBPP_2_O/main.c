...
int rnd_n = 2;     // The number of randomness in IBbpp_2_Mult multiplication gadget
// int Mask_ORD = 2;
...
int main(void)
{
    ...
    for (int i = 0; i < 100; i++) {
        ...
        static uint8_t rnd_gadget[2];   // Random number for Bbpp_2_Mult multiplication
