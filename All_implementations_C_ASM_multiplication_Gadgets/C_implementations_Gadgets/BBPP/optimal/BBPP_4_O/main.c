...
int rnd_n = 5;     // The number of randomness in IBbpp_3_Mult multiplication gadget
//int Mask_ORD = 4;
//////////////////////////////////////////////////////////////////////
int main(void)
{
    ...
    for (int i = 0; i < 100; i++) {
        ...
        static uint8_t rnd_gadget[4];   // Random number for Bbpp_2_Mult multiplication
