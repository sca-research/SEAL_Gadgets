...
/*
    ISW_Belaid_3_Mult(INPUT: input_a[Mask_ORD+1], INPUT: input_b[Mask_ORD+1],INPUT: uint8_t * rnd, OUTPUT: c[Mask_ORD+1])
    c = a * b
        The number of randomness: 4
        */

void Bbpp_3_Mult(uint8_t* a, uint8_t* b,uint8_t* rnd, uint8_t* c)
{
