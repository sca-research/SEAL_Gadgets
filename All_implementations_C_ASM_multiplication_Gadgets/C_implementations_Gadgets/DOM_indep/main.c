...
int rnd_n = Mask_ORD * (Mask_ORD+1) /2; // The number of randomness in DOM_indep multiplication gadget
...
int main(void)
{
    ...
    for (int i = 0; i < 100; i++) {
        ...
        c = a * b
        rnd_Dom_indep: random numbers (on_the_fly)*/
        DOM_independent(a, b, rnd_Dom_indep, c);
